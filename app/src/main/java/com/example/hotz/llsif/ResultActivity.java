...
public class ResultActivity extends ListActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Typeface myTypeface4 = Typeface.createFromAsset(getAssets(),"LISTFCEI.TTF");
        TextView myTextView4 = (TextView)findViewById(R.id.title2);
        ...
        try{
            ...
            if (cursor.moveToFirst()){
                do{
                    ...
                    results.add("Song Name: " + name +  ", Bond Points: "  + String.valueOf(pts) + ", Bond per LP: "+ String.valueOf(bondlp));
